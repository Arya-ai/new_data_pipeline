...
_DATUM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='class', full_name='Datum.class', index=2,
...
_DATUM.fields_by_name['class'].message_type = _CLASS
