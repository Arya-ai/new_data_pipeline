...
model_savePath = '../../models/VGG19_model_3.hdf5'
...
inter_atm = Dense(128, activation='relu', kernel_regularizer=l2(0.01),
...
inter_common = Dense(128, activation='relu', kernel_regularizer=l2(0.01),
...
inter_rare = Dense(128, activation='relu', kernel_regularizer=l2(0.01),
